...
class Option:
    def __init__(self):
        ...
        self.img.resize(83,83);self.img2.resize(83,83);self.img3.resize(83,83);self.img4.resize(83,83);self.imgretour.resize(50,50)
        ...
        buttonApply = Button(self.imgApply,self.font,'Apply')
        ...
        if Mouse_on_window():
            ...
            if click == True:
                for i in range(len(self.button)):
                    g = self.button[i].EventClic(posCursor[0],posCursor[1],lambda : self.__change(self.attribut[i]))
                return self.view
