...
class MenuLevel:
    def __init__(self):
        self.img = Image('assets/img/button/200x50.png');self.img2 = Image('assets/img/button/200x50.png');self.img3 = Image('assets/img/button/200x50.png');self.img4 = Image('assets/img/button/200x50.png');self.img5 = Image('assets/img/button/200x50.png');self.img6 = Image('assets/img/button/200x50.png');self.img7 = Image('assets/img/button/200x50.png');self.img8 = Image('assets/img/button/200x50.png');self.img9 = Image('assets/img/button/200x50.png');self.img10 = Image('assets/img/button/200x50.png');self.imgretour = Image('assets/img/button/retour.png')#créer les objets images
